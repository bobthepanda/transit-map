...
export const MITA_HIBIYA: Coordinates = { ...OTEMACHI , y: OTEMACHI.y + MAJOR_LINE * 2.5 };
export const HIBIYA: Coordinates = { x: MITA_HIBIYA.x + OFFSET * .5, y: MITA_HIBIYA.y + OFFSET };

export const HIBIYA_GINZA: Coordinates = { x: OTEMACHI.x + 3.5 * MAJOR_LINE - OFFSET * .5, y: HIBIYA.y };
...
export const YAMANOTE_YURAKUCHO: Coordinates = { ...YAMANOTE_TOKYO, y: MITA_HIBIYA.y - OFFSET - MAJOR_LINE * .5};
export const YAMANOTE_SHIMBASHI = { ...YAMANOTE_TOKYO, y: YAMANOTE_YURAKUCHO.y + MAJOR_LINE * 2};

export const HIBIYA_KASUMIGASEKI: Coordinates = { x: MITA_HIBIYA.x - MAJOR_LINE, y: MITA_HIBIYA.y + MAJOR_LINE * .5 };
export const NIHOMBASHI: Coordinates = { ...OTEMACHI, x: HIBIYA_GINZA.x + OFFSET * .5 };
