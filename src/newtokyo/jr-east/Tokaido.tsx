...
import { ENE, ESE, midPoint, NNE, NNW, offset, RADIUS, scale, scaleToUnitX, SSE, SSW, W, WSW } from '../../utils/PathUtils';
import { JK_35, JK_36, JK_38, JK_43, JK_46, JK_47 } from './KeihinTohoku';
...
export const TokaidoPath = () => {
    return (
        <SVGPath
            points={[JT_03, offset(JY_28, scale(SSE, OFFSET * 2)), JU_02, JU_03, midPoint(JU_03, JK_36), JU_07]}
            directions={[NNE, ENE, NNE, NNW, W, NNW]}
