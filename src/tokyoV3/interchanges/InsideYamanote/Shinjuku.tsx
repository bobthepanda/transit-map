...
export const S_01 = offset(JC_05, scale(NW, OFFSET * 0.5), scale(SW, OFFSET), scale(SE, OFFSET * 0.5));
export const KO_01 = offset(S_01, scale(NW, OFFSET));

export const M_08 = offset(S_01, scale(SW, OFFSET), scale(SE, OFFSET * 0.5, -1));
export const E_27 = offset(M_08, scale(SW, OFFSET));
export const E_01 = offset(JC_05, scaleToUnitX(N, OFFSET * 3));
export const OH_01 = offset(E_27, scale(SW, OFFSET));
    ...
    return (
        <>
            ...
            <g id="shinjuku">
                ...
                <Stop stationCode="OH 01" location={OH_01} textAlignment={TextAlignment.NW} />
