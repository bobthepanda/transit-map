...
import { E, N, NE, NW, S, W, findIntersectionFromSlopes, offset, scaleToUnitX } from '../../../utils/PathUtils';
...
const JY_19 = offset(
    findIntersectionFromSlopes({ firstDirection: N, start: JY_20, secondDirection: NW, end: C_03 }),
    scaleToUnitX(S, OFFSET)
);
