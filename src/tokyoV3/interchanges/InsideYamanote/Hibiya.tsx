...
export const Hibiya = () => {
    return (
        <g id="hibiya">
            <Stop stationCode="H 08" location={H_08} strokeColor="stroke-hibiya" hideText />
            <Stop stationCode="I 08" location={I_08} strokeColor="stroke-mita" hideText />
            <Stop stationCode="C 09" location={C_09} strokeColor="stroke-chiyoda" textAlignment={TextAlignment.LEFT} />
        </g>
    );
};
