...
export const addTokyo = (dispatch: AppDispatch) => {
    ...
    dispatch(offsetSingleStop('JY 01', { stationCode: 'JK 26', strokeColor: 'stroke-keihin-tohoku', hideText: true }, scale(ESE, OFFSET)));
    dispatch(
        offsetSingleStop(
            'JK 26',
    ...
    dispatch(
        offsetSingleStop(
            'JC 01',
            { stationCode: 'M 17', strokeColor: 'stroke-marunouchi', textAlignment: TextAlignment.WSW },
