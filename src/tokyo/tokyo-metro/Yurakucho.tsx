...
import { E, ESE, NNE, offset, S, scale, scaleToUnitX } from '../../utils/PathUtils';
...
const Y_09_SLOPE = scaleToUnitX(ESE, MAJOR_LINE * 1.5);
export const Y_10 = offset(Y_09, Y_09_SLOPE);
